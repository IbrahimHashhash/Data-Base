...
public class downPayment extends BorderPane {
    ...
    public downPayment() throws SQLException {
        ...
        CustomerDAO.getCustomers().addAll(paymentDAO.getCustomersByPaymentAmount());
    ...
    public void downPay(){
        ...
        button.setOnAction(e -> {
            ...
            double newDown = payment.getAmount() + Integer.parseInt(amount.getText());
    ...
    void handleSearch(String value) {
        try {
            if (value.isEmpty()) {
                ...
                List<Customer> allCustomers = paymentDAO.getCustomersByPaymentAmount();
